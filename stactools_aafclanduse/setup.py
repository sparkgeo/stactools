...
# Borrowed from :Corine stactools

name = f'stactools_aafclanduse'
description = ("Subpackage for working with Agriculture and Agri-Food Canada's Land Use data in stactools, "
    "a command line tool and Python library for working with STAC.")

__version__ = load_source(
    f'stactools.aafclanduse.version',
    os.path.join(os.path.dirname(__file__),
                 f'stactools/aafclanduse/version.py')).__version__
