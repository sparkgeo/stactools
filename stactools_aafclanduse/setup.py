...
description = ("Subpackage for working with 1990, 2000 and 2010 Canada Land Use data in stactools, "
...
__version__ = load_source(
    ...
    os.path.join(os.path.dirname(__file__),
                 f"stactools/aafclanduse/version.py"),
).__version__
...
setup(
    ...
    author_email="smohiuddin@sparkgeo.com",
    ...
    keywords=[
        'stactools', 'psytac', 'Agriculture and Agri-Food Canada', 'landcover', 'raster',
        'catalog', 'STAC'
    ])
